...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MainPage(children: [
       HomeBanner(),
       Responsive(
         mobile: ProjectGridView(crossAxisCount: 1, childAspectRatio: 1.7, ),
         mobileLarge: ProjectGridView(crossAxisCount: 2, childAspectRatio: 1,),
         desktop: ProjectGridView(),
         tablet: ProjectGridView(crossAxisCount: 2, childAspectRatio: 1.3,),
       ),
    ]);
  }
}
        ...
        children: [
          ...
          Expanded(
            child: Padding(
              ...
              child: Text(
                project.desription!,
                maxLines: !Responsive.isDesktop(context) ? Responsive.isMobile(context) ? 3 : 4 : 5,
                overflow: TextOverflow.ellipsis,
